...
defs["enums"]["ImGuiActivateFlags_"][6]["comment"] = "// Activation requested by an item shortcut via SetNextItemShortcut() function."
...
defs["enums"]["ImGuiInputFlags_"][18]["comment"] = "// Register route globally (higher priority: unlikely you need to use that: will interfere with every active items, e.g. CTRL+A registered by InputText will be overriden by this)"
...
defs["enums"]["ImGuiInputTextFlagsPrivate_"][4]["comment"] = "// For internal use by InputScalar() and TempInputScalar()"
...
defs["enums"]["ImGuiNavHighlightFlags_"][2]["comment"] = "// Compact highlight, no padding"
...
defs["enums"]["ImGuiNavHighlightFlags_"][3]["comment"] = "// Draw rectangular highlight if (g.NavId == id) _even_ when using the mouse."
...
defs["enums"]["ImGuiNavMoveFlags_"][18]["comment"] = "// (Experimental) Do not clear active id when applying move result"
...
defs["enums"]["ImGuiStyleVar_"][24]["comment"] = "// float     TabBorderSize"
...
defs["enums"]["ImGuiStyleVar_"][25]["comment"] = "// float     TabBarBorderSize"
...
defs["enums"]["ImGuiStyleVar_"][26]["comment"] = "// float  TableAngledHeadersAngle"
...
defs["enums"]["ImGuiStyleVar_"][27]["comment"] = "// ImVec2    ButtonTextAlign"
...
defs["enums"]["ImGuiStyleVar_"][28]["comment"] = "// ImVec2    SelectableTextAlign"
...
defs["enums"]["ImGuiStyleVar_"][29]["comment"] = "// float  SeparatorTextBorderSize"
...
defs["enums"]["ImGuiStyleVar_"][30]["comment"] = "// ImVec2    SeparatorTextAlign"
...
defs["enums"]["ImGuiStyleVar_"][31]["comment"] = "// ImVec2    SeparatorTextPadding"
...
defs["enums"]["ImGuiStyleVar_"][32]["comment"] = "// float     DockingSeparatorSize"
...
defs["struct_comments"]["ImGuiPopupData"]["above"] = "// Storage for popup stacks (g.OpenPopupStack and g.BeginPopupStack)"
...
defs["structs"]["ImGuiContext"][64]["comment"]["sameline"] = "// Clicked offset from upper-left corner, if applicable (currently only set by ButtonBehavior)"
...
defs["structs"]["ImGuiContext"][66]["comment"]["sameline"] = "// Activating source: ImGuiInputSource_Mouse OR ImGuiInputSource_Keyboard OR ImGuiInputSource_Gamepad"
...
defs["structs"]["ImGuiContext"][71]["comment"]["sameline"] = "// Store the last non-zero ActiveId, useful for animation."
...
defs["structs"]["ImGuiContext"][72]["comment"]["sameline"] = "// Store the last non-zero ActiveId timer since the beginning of activation, useful for animation."
...
defs["structs"]["ImGuiContext"][73]["comment"]["above"] = "    // [EXPERIMENTAL] Key/Input Ownership + Shortcut Routing system\
...
defs["structs"]["ImGuiContext"][73]["comment"]["sameline"] = "// Record the last time key mods changed (affect repeat delay when using shortcut logic)"
...
defs["structs"]["ImGuiContext"][74]["comment"]["sameline"] = "// Record the last time key mods changed away from being 0 (affect repeat delay when using shortcut logic)"
...
defs["structs"]["ImGuiContext"][75]["comment"]["sameline"] = "// Record the last time a keyboard key (ignore mouse/gamepad ones) was pressed."
...
defs["structs"]["ImGuiContext"][76]["comment"]["sameline"] = "// Lookup to tell if a key can emit char input, see IsKeyChordPotentiallyCharInput(). sizeof() = 20 bytes"
...
defs["structs"]["ImGuiContext"][79]["comment"]["sameline"] = "// Active widget will want to read those nav move requests (e.g. can activate a button and move away from it)"
...
defs["structs"]["ImGuiContext"][80]["comment"]["sameline"] = "// Active widget will want to read all keyboard keys inputs. (FIXME: This is a shortcut for not taking ownership of 100+ keys but perhaps best to not have the inconsistency)"
...
defs["structs"]["ImGuiContext"][81]["comment"]["sameline"] = "// Set to break in SetShortcutRouting()/Shortcut() calls."
...
defs["structs"]["ImGuiContext"][82]["comment"]["above"] = "    // Next window/item data"
defs["structs"]["ImGuiContext"][82]["comment"]["sameline"] = "// Value for currently appending items == g.FocusScopeStack.back(). Not to be mistaken with g.NavFocusScopeId."
...
defs["structs"]["ImGuiContext"][83]["comment"]["sameline"] = "// Value for currently appending items == g.ItemFlagsStack.back()"
...
defs["structs"]["ImGuiContext"][84]["comment"]["sameline"] = "// Storage for DebugLocateItemOnHover() feature: this is read by ItemAdd() so we keep it in a hot/cached location"
...
defs["structs"]["ImGuiContext"][85]["comment"]["sameline"] = "// Storage for SetNextItem** functions"
...
defs["structs"]["ImGuiContext"][86]["comment"]["sameline"] = "// Storage for last submitted item (setup by ItemAdd)"
...
defs["structs"]["ImGuiContext"][87]["comment"]["sameline"] = "// Storage for SetNextWindow** functions"
...
defs["structs"]["ImGuiContext"][89]["comment"]["above"] = "    // Shared stacks"
defs["structs"]["ImGuiContext"][89]["comment"]["sameline"] = "// (Keep close to ColorStack to share cache line)"
...
defs["structs"]["ImGuiContext"][90]["comment"]["sameline"] = "// Stack for PushStyleColor()/PopStyleColor() - inherited by Begin()"
...
defs["structs"]["ImGuiContext"][91]["comment"]["sameline"] = "// Stack for PushStyleVar()/PopStyleVar() - inherited by Begin()"
...
defs["structs"]["ImGuiContext"][92]["comment"]["sameline"] = "// Stack for PushFont()/PopFont() - inherited by Begin()"
...
defs["structs"]["ImGuiContext"][93]["comment"]["sameline"] = "// Stack for PushFocusScope()/PopFocusScope() - inherited by BeginChild(), pushed into by Begin()"
...
defs["structs"]["ImGuiContext"][94]["comment"]["sameline"] = "// Stack for PushItemFlag()/PopItemFlag() - inherited by Begin()"
...
defs["structs"]["ImGuiContext"][95]["comment"]["sameline"] = "// Stack for BeginGroup()/EndGroup() - not inherited by Begin()"
...
defs["structs"]["ImGuiContext"][96]["comment"]["sameline"] = "// Which popups are open (persistent)"
...
defs["structs"]["ImGuiContext"][97]["comment"]["sameline"] = "// Which level of BeginPopup() we are in (reset every frame)"
...
defs["structs"]["ImGuiContext"][98]["comment"]["sameline"] = "// Stack for TreeNode() when a NavLeft requested is emitted."
...
defs["structs"]["ImGuiContext"][106]["comment"]["sameline"] = "// Bounding box of all platform monitors"
...
defs["structs"]["ImGuiContext"][108]["comment"]["sameline"] = "// Unique sequential creation counter (mostly for testing/debugging)"
...
defs["structs"]["ImGuiContext"][109]["comment"]["sameline"] = "// Every time the front-most window changes, we stamp its viewport with an incrementing counter"
...
defs["structs"]["ImGuiContext"][110]["comment"]["above"] = "    // Gamepad/keyboard Navigation"
defs["structs"]["ImGuiContext"][110]["comment"]["sameline"] = "// Focused window for navigation. Could be called 'FocusedWindow'"
...
defs["structs"]["ImGuiContext"][111]["comment"]["sameline"] = "// Focused item for navigation"
...
defs["structs"]["ImGuiContext"][112]["comment"]["sameline"] = "// Focused focus scope (e.g. selection code often wants to \"clear other items\" when landing on an item of the same scope)"
...
defs["structs"]["ImGuiContext"][113]["comment"]["sameline"] = "// Reversed copy focus scope stack for NavId (should contains NavFocusScopeId). This essentially follow the window->ParentWindowForFocusRoute chain."
...
defs["structs"]["ImGuiContext"][114]["comment"]["sameline"] = "// ~~ (g.ActiveId == 0) && (IsKeyPressed(ImGuiKey_Space) || IsKeyDown(ImGuiKey_Enter) || IsKeyPressed(ImGuiKey_NavGamepadActivate)) ? NavId : 0, also set when calling ActivateItem()"
...
defs["structs"]["ImGuiContext"][115]["comment"]["sameline"] = "// ~~ IsKeyDown(ImGuiKey_Space) || IsKeyDown(ImGuiKey_Enter) || IsKeyDown(ImGuiKey_NavGamepadActivate) ? NavId : 0"
...
defs["structs"]["ImGuiContext"][116]["comment"]["sameline"] = "// ~~ IsKeyPressed(ImGuiKey_Space) || IsKeyPressed(ImGuiKey_Enter) || IsKeyPressed(ImGuiKey_NavGamepadActivate) ? NavId : 0 (no repeat)"
...
defs["structs"]["ImGuiContext"][120]["comment"]["sameline"] = "// Just navigated to this id (result of a successfully MoveRequest)."
...
defs["structs"]["ImGuiContext"][121]["comment"]["sameline"] = "// Just navigated to this focus scope id (result of a successfully MoveRequest)."
...
defs["structs"]["ImGuiContext"][123]["comment"]["sameline"] = "// Set by ActivateItem(), queued until next frame."
...
defs["structs"]["ImGuiContext"][125]["comment"]["sameline"] = "// Keyboard or Gamepad mode? THIS CAN ONLY BE ImGuiInputSource_Keyboard or ImGuiInputSource_Mouse"
...
defs["structs"]["ImGuiContext"][126]["comment"]["sameline"] = "// Layer we are navigating on. For now the system is hard-coded for 0=main contents and 1=menu/title bar, may expose layers later."
...
defs["structs"]["ImGuiContext"][127]["comment"]["sameline"] = "// Last valid data passed to SetNextItemSelectionUser(), or -1. For current window. Not reset when focusing an item that doesn't have selection data."
...
defs["structs"]["ImGuiContext"][128]["comment"]["sameline"] = "// Nav widget has been seen this frame ~~ NavRectRel is valid"
...
defs["structs"]["ImGuiContext"][129]["comment"]["sameline"] = "// When set we will update mouse position if (io.ConfigFlags & ImGuiConfigFlags_NavEnableSetMousePos) if set (NB: this not enabled by default)"
...
defs["structs"]["ImGuiContext"][130]["comment"]["sameline"] = "// When user starts using mouse, we hide gamepad/keyboard highlight (NB: but they are still available, which is why NavDisableHighlight isn't always != NavDisableMouseHover)"
...
defs["structs"]["ImGuiContext"][131]["comment"]["sameline"] = "// When user starts using gamepad/keyboard, we hide mouse hovering highlight until mouse is touched again."
...
defs["structs"]["ImGuiContext"][132]["comment"]["above"] = "    // Navigation: Init & Move Requests"
defs["structs"]["ImGuiContext"][132]["comment"]["sameline"] = "// ~~ NavMoveRequest || NavInitRequest this is to perform early out in ItemAdd()"
...
defs["structs"]["ImGuiContext"][133]["comment"]["sameline"] = "// Init request for appearing window to select first item"
...
defs["structs"]["ImGuiContext"][135]["comment"]["sameline"] = "// Init request result (first item of the window, or one for which SetItemDefaultFocus() was called)"
...
defs["structs"]["ImGuiContext"][136]["comment"]["sameline"] = "// Move request submitted, will process result on next NewFrame()"
...
defs["structs"]["ImGuiContext"][137]["comment"]["sameline"] = "// Move request submitted, still scoring incoming items"
...
defs["structs"]["ImGuiContext"][142]["comment"]["sameline"] = "// Direction of the move request (left/right/up/down)"
...
defs["structs"]["ImGuiContext"][144]["comment"]["sameline"] = "// FIXME-NAV: Describe the purpose of this better. Might want to rename?"
...
defs["structs"]["ImGuiContext"][145]["comment"]["sameline"] = "// Rectangle used for scoring, in screen space. Based of window->NavRectRel[], modified for directional navigation scoring."
...
defs["structs"]["ImGuiContext"][146]["comment"]["sameline"] = "// Some nav operations (such as PageUp/PageDown) enforce a region which clipper will attempt to always keep submitted"
...
defs["structs"]["ImGuiContext"][147]["comment"]["sameline"] = "// Metrics for debugging"
...
defs["structs"]["ImGuiContext"][148]["comment"]["sameline"] = "// Generally -1 or +1, 0 when tabbing without a nav id"
...
defs["structs"]["ImGuiContext"][149]["comment"]["sameline"] = "// >0 when counting items for tabbing"
...
defs["structs"]["ImGuiContext"][150]["comment"]["sameline"] = "// Best move request candidate within NavWindow"
...
defs["structs"]["ImGuiContext"][151]["comment"]["sameline"] = "// Best move request candidate within NavWindow that are mostly visible (when using ImGuiNavMoveFlags_AlsoScoreVisibleSet flag)"
...
defs["structs"]["ImGuiContext"][152]["comment"]["sameline"] = "// Best move request candidate within NavWindow's flattened hierarchy (when using ImGuiWindowFlags_NavFlattened flag)"
...
defs["structs"]["ImGuiContext"][153]["comment"]["sameline"] = "// First tabbing request candidate within NavWindow and flattened hierarchy"
...
defs["structs"]["ImGuiContext"][154]["comment"]["above"] = "    // Navigation: Windowing (CTRL+TAB for list, or Menu button + keys or directional pads to move/resize)"
defs["structs"]["ImGuiContext"][154]["comment"]["sameline"] = "// = ImGuiMod_Ctrl | ImGuiKey_Tab, for reconfiguration (see #4828)"
...
defs["structs"]["ImGuiContext"][155]["comment"]["sameline"] = "// = ImGuiMod_Ctrl | ImGuiMod_Shift | ImGuiKey_Tab"
...
defs["structs"]["ImGuiContext"][156]["comment"]["sameline"] = "// Target window when doing CTRL+Tab (or Pad Menu + FocusPrev/Next), this window is temporarily displayed top-most!"
...
defs["structs"]["ImGuiContext"][157]["comment"]["sameline"] = "// Record of last valid NavWindowingTarget until DimBgRatio and NavWindowingHighlightAlpha becomes 0.0f, so the fade-out can stay on it."
...
defs["structs"]["ImGuiContext"][158]["comment"]["sameline"] = "// Internal window actually listing the CTRL+Tab contents"
...
defs["structs"]["ImGuiContext"][165]["comment"]["above"] = "    // Render"
defs["structs"]["ImGuiContext"][165]["comment"]["sameline"] = "// 0.0..1.0 animation when fading in a dimming background (for modal window and CTRL+TAB list)"
...
defs["structs"]["ImGuiContext"][166]["comment"]["above"] = "    // Drag and Drop"
...
defs["structs"]["ImGuiContext"][167]["comment"]["sameline"] = "// Set when within a BeginDragDropXXX/EndDragDropXXX block for a drag source."
...
defs["structs"]["ImGuiContext"][168]["comment"]["sameline"] = "// Set when within a BeginDragDropXXX/EndDragDropXXX block for a drag target."
...
defs["structs"]["ImGuiContext"][173]["comment"]["sameline"] = "// Store rectangle of current target candidate (we favor small targets when overlapping)"
...
defs["structs"]["ImGuiContext"][174]["comment"]["sameline"] = "// Store ClipRect at the time of item's drawing"
...
defs["structs"]["ImGuiContext"][177]["comment"]["sameline"] = "// Target item surface (we resolve overlapping targets by prioritizing the smaller surface)"
...
defs["structs"]["ImGuiContext"][178]["comment"]["sameline"] = "// Target item id (set at the time of accepting the payload)"
...
defs["structs"]["ImGuiContext"][179]["comment"]["sameline"] = "// Target item id from previous frame (we need to store this to allow for overlapping drag and drop targets)"
...
defs["structs"]["ImGuiContext"][180]["comment"]["sameline"] = "// Last time a target expressed a desire to accept the source"
...
defs["structs"]["ImGuiContext"][181]["comment"]["sameline"] = "// Set when holding a payload just made ButtonBehavior() return a press."
...
defs["structs"]["ImGuiContext"][182]["comment"]["sameline"] = "// We don't expose the ImVector<> directly, ImGuiPayload only holds pointer+size"
...
defs["structs"]["ImGuiContext"][183]["comment"]["sameline"] = "// Local buffer for small payloads"
...
defs["structs"]["ImGuiContext"][184]["comment"]["above"] = "    // Clipper"
...
defs["structs"]["ImGuiContext"][186]["comment"]["above"] = "    // Tables"
...
defs["structs"]["ImGuiContext"][187]["comment"]["sameline"] = "// Set to break in BeginTable() call."
...
defs["structs"]["ImGuiContext"][188]["comment"]["sameline"] = "// Temporary table data size (because we leave previous instances undestructed, we generally don't use TablesTempData.Size)"
...
defs["structs"]["ImGuiContext"][189]["comment"]["sameline"] = "// Temporary table data (buffers reused/shared across instances, support nesting)"
...
defs["structs"]["ImGuiContext"][190]["comment"]["sameline"] = "// Persistent table data"
...
defs["structs"]["ImGuiContext"][191]["comment"]["sameline"] = "// Last used timestamp of each tables (SOA, for efficient GC)"
...
defs["structs"]["ImGuiContext"][193]["comment"]["above"] = "    // Tab bars"
...
defs["structs"]["ImGuiContext"][197]["comment"]["above"] = "    // Hover Delay system"
...
defs["structs"]["ImGuiContext"][199]["comment"]["sameline"] = "// Currently used by IsItemHovered()"
...
defs["structs"]["ImGuiContext"][200]["comment"]["sameline"] = "// Currently used by IsItemHovered(): grace time before g.TooltipHoverTimer gets cleared."
...
defs["structs"]["ImGuiContext"][201]["comment"]["sameline"] = "// Mouse has once been stationary on this item. Only reset after departing the item."
...
defs["structs"]["ImGuiContext"][202]["comment"]["sameline"] = "// Mouse has once been stationary on this window. Only reset after departing the window."
...
defs["structs"]["ImGuiContext"][203]["comment"]["above"] = "    // Mouse state"
...
defs["structs"]["ImGuiContext"][204]["comment"]["sameline"] = "// Time the mouse has been stationary (with some loose heuristic)"
...
defs["structs"]["ImGuiContext"][206]["comment"]["above"] = "    // Widget state"
...
defs["structs"]["ImGuiContext"][209]["comment"]["sameline"] = "// Temporary text input when CTRL+clicking on a slider, etc."
...
defs["structs"]["ImGuiContext"][212]["comment"]["sameline"] = "// Store user options for color edit widgets"
...
defs["structs"]["ImGuiContext"][213]["comment"]["sameline"] = "// Set temporarily while inside of the parent-most ColorEdit4/ColorPicker4 (because they call each others)."
...
defs["structs"]["ImGuiContext"][214]["comment"]["sameline"] = "// ID we are saving/restoring HS for"
...
defs["structs"]["ImGuiContext"][215]["comment"]["sameline"] = "// Backup of last Hue associated to LastColor, so we can restore Hue in lossy RGB<>HSV round trips"
...
defs["structs"]["ImGuiContext"][216]["comment"]["sameline"] = "// Backup of last Saturation associated to LastColor, so we can restore Saturation in lossy RGB<>HSV round trips"
...
defs["structs"]["ImGuiContext"][217]["comment"]["sameline"] = "// RGB value with alpha set to 0."
...
defs["structs"]["ImGuiContext"][218]["comment"]["sameline"] = "// Initial/reference color at the time of opening the color picker."
...
defs["structs"]["ImGuiContext"][220]["comment"]["sameline"] = "// Expected border rect, switch to relative edit if moving"
...
defs["structs"]["ImGuiContext"][223]["comment"]["sameline"] = "// Accumulated slider delta when using navigation controls."
...
defs["structs"]["ImGuiContext"][224]["comment"]["sameline"] = "// Has the accumulated slider delta changed since last time we tried to apply it?"
...
defs["structs"]["ImGuiContext"][226]["comment"]["sameline"] = "// Accumulator for dragging modification. Always high-precision, not rounded by end-user precision settings"
...
defs["structs"]["ImGuiContext"][227]["comment"]["sameline"] = "// If speed == 0.0f, uses (max-min) * DragSpeedDefaultRatio"
...
defs["structs"]["ImGuiContext"][228]["comment"]["sameline"] = "// Distance between mouse and center of grab box, normalized in parent space. Use storage?"
...
defs["structs"]["ImGuiContext"][229]["comment"]["sameline"] = "// Backup for style.Alpha for BeginDisabled()"
...
defs["structs"]["ImGuiContext"][233]["comment"]["sameline"] = "// If no custom clipboard handler is defined"
...
defs["structs"]["ImGuiContext"][234]["comment"] = {}
defs["structs"]["ImGuiContext"][234]["comment"]["sameline"] = "// A list of menu IDs that were rendered at least once"
...
defs["structs"]["ImGuiContext"][235]["comment"]["sameline"] = "// State for GetTypingSelectRequest()"
...
defs["structs"]["ImGuiContext"][236]["comment"]["above"] = "    // Platform support"
defs["structs"]["ImGuiContext"][236]["comment"]["sameline"] = "// Data updated by current frame"
...
defs["structs"]["ImGuiContext"][237]["comment"]["sameline"] = "// Previous frame data (when changing we will call io.SetPlatformImeDataFn"
...
defs["structs"]["ImGuiContext"][239]["comment"]["above"] = "    // Extensions\
...
defs["structs"]["ImGuiContext"][241]["comment"]["above"] = "    // Settings"
...
defs["structs"]["ImGuiContext"][242]["comment"]["sameline"] = "// Save .ini Settings to memory when time reaches zero"
...
defs["structs"]["ImGuiContext"][243]["comment"]["sameline"] = "// In memory .ini settings"
...
defs["structs"]["ImGuiContext"][244]["comment"]["sameline"] = "// List of .ini settings handlers"
...
defs["structs"]["ImGuiContext"][245]["comment"]["sameline"] = "// ImGuiWindow .ini settings entries"
...
defs["structs"]["ImGuiContext"][246]["comment"]["sameline"] = "// ImGuiTable .ini settings entries"
...
defs["structs"]["ImGuiContext"][247]["comment"]["sameline"] = "// Hooks for extensions (e.g. test engine)"
...
defs["structs"]["ImGuiContext"][248]["comment"] = {}
defs["structs"]["ImGuiContext"][248]["comment"]["sameline"] = "// Next available HookId"
defs["structs"]["ImGuiContext"][248]["name"] = "HookIdNext"
defs["structs"]["ImGuiContext"][248]["type"] = "ImGuiID"
defs["structs"]["ImGuiContext"][249] = {}
defs["structs"]["ImGuiContext"][249]["comment"] = {}
defs["structs"]["ImGuiContext"][249]["comment"]["above"] = "    // Localization"
...
defs["structs"]["ImGuiContext"][250]["comment"] = {}
defs["structs"]["ImGuiContext"][250]["comment"]["above"] = "    // Capture/Logging"
defs["structs"]["ImGuiContext"][250]["comment"]["sameline"] = "// Currently capturing"
defs["structs"]["ImGuiContext"][250]["name"] = "LogEnabled"
defs["structs"]["ImGuiContext"][250]["type"] = "bool"
defs["structs"]["ImGuiContext"][251] = {}
defs["structs"]["ImGuiContext"][251]["comment"] = {}
defs["structs"]["ImGuiContext"][251]["comment"]["sameline"] = "// Capture target"
defs["structs"]["ImGuiContext"][251]["name"] = "LogType"
defs["structs"]["ImGuiContext"][251]["type"] = "ImGuiLogType"
defs["structs"]["ImGuiContext"][252] = {}
defs["structs"]["ImGuiContext"][252]["comment"] = {}
defs["structs"]["ImGuiContext"][252]["comment"]["sameline"] = "// If != NULL log to stdout/ file"
defs["structs"]["ImGuiContext"][252]["name"] = "LogFile"
defs["structs"]["ImGuiContext"][252]["type"] = "ImFileHandle"
defs["structs"]["ImGuiContext"][253] = {}
defs["structs"]["ImGuiContext"][253]["comment"] = {}
defs["structs"]["ImGuiContext"][253]["comment"]["sameline"] = "// Accumulation buffer when log to clipboard. This is pointer so our GImGui static constructor doesn't call heap allocators."
...
defs["structs"]["ImGuiContext"][260]["comment"]["sameline"] = "// Default/stored value for LogDepthMaxExpand if not specified in the LogXXX function call."
...
defs["structs"]["ImGuiContext"][261]["comment"]["above"] = "    // Debug Tools\
...
defs["structs"]["ImGuiContext"][266]["comment"]["sameline"] = "// For DebugLocateItemOnHover(). This is used together with DebugLocateId which is in a hot/cached spot above."
defs["structs"]["ImGuiContext"][266]["name"] = "DebugLocateFrames"
defs["structs"]["ImGuiContext"][266]["type"] = "ImU8"
defs["structs"]["ImGuiContext"][267] = {}
defs["structs"]["ImGuiContext"][267]["comment"] = {}
defs["structs"]["ImGuiContext"][267]["comment"]["sameline"] = "// Debug break in ItemAdd() call for g.DebugLocateId."
...
defs["structs"]["ImGuiContext"][268]["comment"] = {}
defs["structs"]["ImGuiContext"][268]["comment"]["sameline"] = "// = ImGuiKey_Pause"
...
defs["structs"]["ImGuiContext"][269]["comment"] = {}
defs["structs"]["ImGuiContext"][269]["comment"]["sameline"] = "// Cycle between 0..9 then wrap around."
...
defs["structs"]["ImGuiContext"][270]["comment"] = {}
defs["structs"]["ImGuiContext"][270]["comment"]["sameline"] = "// Item picker is active (started with DebugStartItemPicker())"
...
defs["structs"]["ImGuiContext"][272]["comment"]["sameline"] = "// Will call IM_DEBUG_BREAK() when encountering this ID"
...
defs["structs"]["ImGuiContext"][278]["comment"]["sameline"] = "// Hovered dock node."
...
defs["structs"]["ImGuiContext"][279]["comment"] = {}
defs["structs"]["ImGuiContext"][279]["comment"]["above"] = "    // Misc"
defs["structs"]["ImGuiContext"][279]["comment"]["sameline"] = "// Calculate estimate of framerate for user over the last 60 frames.."
...
defs["structs"]["ImGuiContext"][283]["comment"] = {}
defs["structs"]["ImGuiContext"][283]["comment"]["sameline"] = "// Explicit capture override via SetNextFrameWantCaptureMouse()/SetNextFrameWantCaptureKeyboard(). Default to -1."
...
defs["structs"]["ImGuiContext"][284]["comment"] = {}
defs["structs"]["ImGuiContext"][284]["comment"]["sameline"] = "// \""
...
defs["structs"]["ImGuiContext"][286]["comment"] = {}
defs["structs"]["ImGuiContext"][286]["comment"]["sameline"] = "// Temporary text buffer"
...
defs["structs"]["ImGuiInputTextState"][7]["comment"]["sameline"] = "// value to revert to when pressing Escape = backup of end-user buffer at the time of focus (in UTF-8, unaltered)"
...
defs["structs"]["ImGuiInputTextState"][17]["comment"] = {}
defs["structs"]["ImGuiInputTextState"][17]["comment"]["sameline"] = "// force a reload of user buf so it may be modified externally. may be automatic in future version."
...
defs["structs"]["ImGuiInputTextState"][18]["comment"] = {}
defs["structs"]["ImGuiInputTextState"][18]["comment"]["sameline"] = "// POSITIONS ARE IN IMWCHAR units *NOT* UTF-8 this is why this is not exposed yet."
...
defs["structs"]["ImGuiNextItemData"][5]["comment"]["sameline"] = "// Set by SetNextItemShortcut()"
...
defs["structs"]["ImGuiNextItemData"][6]["comment"] = {}
defs["structs"]["ImGuiNextItemData"][6]["comment"]["sameline"] = "// Set by SetNextItemOpen()"
...
defs["structs"]["ImGuiStyle"][18]["comment"]["sameline"] = "// Padding within a table cell. Cellpadding.x is locked for entire table. CellPadding.y may be altered between different rows."
...
defs["structs"]["ImGuiWindowTempData"][34]["comment"]["above"] = "    // Local parameters stacks\
    // We store the current settings outside of the vectors to increase memory locality (reduce cache misses). The vectors are rarely modified. Also it allows us to not heap allocate for short-lived windows which are not using those settings."
defs["structs"]["ImGuiWindowTempData"][34]["comment"]["sameline"] = "// Current item width (>0.0: width in pixels, <0.0: align xx pixels to the right of window)."
...
defs["structs"]["ImGuiWindowTempData"][35]["comment"]["sameline"] = "// Current text wrap pos."
...
defs["structs"]["ImGuiWindowTempData"][36]["comment"]["sameline"] = "// Store item widths to restore (attention: .back() is not == ItemWidth)"
...
defs["structs"]["ImGuiWindowTempData"][37]["comment"] = {}
defs["structs"]["ImGuiWindowTempData"][37]["comment"]["sameline"] = "// Store text wrap pos to restore (attention: .back() is not == TextWrapPos)"
